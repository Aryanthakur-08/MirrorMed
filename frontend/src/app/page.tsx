...
export default function Home() {
  ...
  const [selectedModule, setSelectedModule] = useState<"cohort" | "doctors" | null>(() => {
    if (typeof window !== "undefined") {
      return sessionStorage.getItem("selectedModule") as "cohort" | "doctors" | null;
    }
    return null;
  });
  const [activeTab, setActiveTab] = useState<Tab>(() => {
    if (typeof window !== "undefined") {
      return (sessionStorage.getItem("activeTab") as Tab) || "analytics";
    }
    return "analytics";
  });
  ...
  }, [selectedModule, activeTab, patients, doctors]);
